...
public:
	...
	// Float as FString with precision
	...
	static AActor* GetClosestActorFromLocation(TArray<AActor*> ActorsToCheck, FVector TargetLocation);

	/*template<typename TEnum>
	static void PrintEnumToScreen(const FString& Name, TEnum Value);*/

	const static int32 UniqueKey = 0;
};
